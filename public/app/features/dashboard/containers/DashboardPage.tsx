...
export class UnthemedDashboardPage extends PureComponent<Props, State> {
  ...
  render() {
    ...
    const showSubMenu = !editPanel && (!kioskMode || kioskMode === KioskMode.FullVar) && !this.props.queryParams.editview;

    const showToolbar = kioskMode !== KioskMode.FullVar && kioskMode !== KioskMode.Full && !queryParams.editview;
